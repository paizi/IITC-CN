...
window.ornaments.setup = function() {
  ...
  window.addLayerGroup('特殊标记', window.ornaments._layer, true);
  window.addLayerGroup('信标', window.ornaments._beacons, true);
  window.addLayerGroup('液压器', window.ornaments._frackers, true);
};
